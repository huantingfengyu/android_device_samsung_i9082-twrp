...
# Kernel
TARGET_KERNEL_CONFIG := nebula_i9082_defconfig
...
# Recovery
TARGET_RECOVERY_FSTAB := device/samsung/i9082/twrp.fstab
TARGET_RECOVERY_INITRC := device/samsung/i9082/init.recovery.capri_ss_baffin.rc
